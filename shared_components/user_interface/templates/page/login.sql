...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1771482038261878281)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771482391015878281)
,p_page_template_id=>wwv_flow_imp.id(1771482038261878281)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771482677394878281)
,p_page_template_id=>wwv_flow_imp.id(1771482038261878281)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771482957866878281)
,p_page_template_id=>wwv_flow_imp.id(1771482038261878281)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771483292656878281)
,p_page_template_id=>wwv_flow_imp.id(1771482038261878281)
,p_name=>'Body Footer'
