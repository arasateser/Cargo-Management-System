...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1771492075103878285)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771492383253878285)
,p_page_template_id=>wwv_flow_imp.id(1771492075103878285)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771492638974878285)
,p_page_template_id=>wwv_flow_imp.id(1771492075103878285)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771492914078878286)
,p_page_template_id=>wwv_flow_imp.id(1771492075103878285)
