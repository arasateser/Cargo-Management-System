...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771565751472878319)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771566002461878320)
,p_plug_template_id=>wwv_flow_imp.id(1771565751472878319)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771566377971878320)
,p_plug_template_id=>wwv_flow_imp.id(1771565751472878319)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771566670912878320)
,p_plug_template_id=>wwv_flow_imp.id(1771565751472878319)
,p_name=>'Button Start'
