...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771570786954878322)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771571067881878322)
,p_plug_template_id=>wwv_flow_imp.id(1771570786954878322)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771571329002878322)
,p_plug_template_id=>wwv_flow_imp.id(1771570786954878322)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771571622255878322)
,p_plug_template_id=>wwv_flow_imp.id(1771570786954878322)
,p_name=>'Sub Regions'
