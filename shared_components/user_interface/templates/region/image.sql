...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771543695808878309)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771543923541878309)
,p_plug_template_id=>wwv_flow_imp.id(1771543695808878309)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771544271627878309)
,p_plug_template_id=>wwv_flow_imp.id(1771543695808878309)
,p_name=>'Sub Regions'
