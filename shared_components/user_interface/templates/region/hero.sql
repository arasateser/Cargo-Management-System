...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771540480553878308)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771540785970878308)
,p_plug_template_id=>wwv_flow_imp.id(1771540480553878308)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771541082224878308)
,p_plug_template_id=>wwv_flow_imp.id(1771540480553878308)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771541373672878308)
,p_plug_template_id=>wwv_flow_imp.id(1771540480553878308)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771541616301878308)
,p_plug_template_id=>wwv_flow_imp.id(1771540480553878308)
,p_name=>'Sub Regions'
