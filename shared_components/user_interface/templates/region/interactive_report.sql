...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771563616017878318)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771563940396878319)
,p_plug_template_id=>wwv_flow_imp.id(1771563616017878318)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771564237745878319)
,p_plug_template_id=>wwv_flow_imp.id(1771563616017878318)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771564574480878319)
,p_plug_template_id=>wwv_flow_imp.id(1771563616017878318)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771564884303878319)
,p_plug_template_id=>wwv_flow_imp.id(1771563616017878318)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771565141476878319)
,p_plug_template_id=>wwv_flow_imp.id(1771563616017878318)
,p_name=>'Sub Regions'
