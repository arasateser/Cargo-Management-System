...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771502205808878290)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771502520666878290)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771502816085878290)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771503123719878291)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771503415127878291)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771503743029878291)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771504050600878291)
,p_plug_template_id=>wwv_flow_imp.id(1771502205808878290)
,p_name=>'Sub Regions'
