...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771508895873878293)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771509161304878293)
,p_plug_template_id=>wwv_flow_imp.id(1771508895873878293)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771509495545878294)
,p_plug_template_id=>wwv_flow_imp.id(1771508895873878293)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771509731338878294)
,p_plug_template_id=>wwv_flow_imp.id(1771508895873878293)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771510095748878294)
,p_plug_template_id=>wwv_flow_imp.id(1771508895873878293)
,p_name=>'Sub Regions'
