...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771590720562878330)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771591052305878330)
,p_plug_template_id=>wwv_flow_imp.id(1771590720562878330)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771591308525878330)
,p_plug_template_id=>wwv_flow_imp.id(1771590720562878330)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771591604090878330)
,p_plug_template_id=>wwv_flow_imp.id(1771590720562878330)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771591932247878331)
,p_plug_template_id=>wwv_flow_imp.id(1771590720562878330)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771592274437878331)
,p_plug_template_id=>wwv_flow_imp.id(1771590720562878330)
