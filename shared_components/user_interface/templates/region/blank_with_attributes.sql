...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771507406730878293)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771507797267878293)
,p_plug_template_id=>wwv_flow_imp.id(1771507406730878293)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771508038016878293)
,p_plug_template_id=>wwv_flow_imp.id(1771507406730878293)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771508336273878293)
,p_plug_template_id=>wwv_flow_imp.id(1771507406730878293)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771508639971878293)
,p_plug_template_id=>wwv_flow_imp.id(1771507406730878293)
,p_name=>'Sub Regions'
