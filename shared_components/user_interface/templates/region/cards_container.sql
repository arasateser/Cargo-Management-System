...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771514515667878296)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771514848810878296)
,p_plug_template_id=>wwv_flow_imp.id(1771514515667878296)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771515103313878296)
,p_plug_template_id=>wwv_flow_imp.id(1771514515667878296)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771515451008878296)
,p_plug_template_id=>wwv_flow_imp.id(1771514515667878296)
,p_name=>'Sub Regions'
