...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771568200468878321)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771568518992878321)
,p_plug_template_id=>wwv_flow_imp.id(1771568200468878321)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771568819805878321)
,p_plug_template_id=>wwv_flow_imp.id(1771568200468878321)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771569147451878321)
,p_plug_template_id=>wwv_flow_imp.id(1771568200468878321)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771569489559878321)
,p_plug_template_id=>wwv_flow_imp.id(1771568200468878321)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771569757557878321)
,p_plug_template_id=>wwv_flow_imp.id(1771568200468878321)
,p_name=>'Sub Regions'
