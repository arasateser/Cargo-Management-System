...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1771535893273878305)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771536141272878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771536499249878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771536790052878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771537018606878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771537397883878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1771537664346878306)
,p_plug_template_id=>wwv_flow_imp.id(1771535893273878305)
,p_name=>'Sub Regions'
