prompt --application/shared_components/user_interface/lovs/cargo_cargo_type_1
begin
--   Manifest
--     CARGO.CARGO_TYPE_1
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(20071545585203718798)
,p_lov_name=>'CARGO.CARGO_TYPE_1'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'CARGO'
,p_return_column_name=>'BRANCH_BRANCH_NO'
